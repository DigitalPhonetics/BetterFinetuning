...
from Training.NonContrastiveLearning import (
    AgeDataset,
...
from Training.NonContrastiveLearning import IEMOCAPDataset, generate_iemocap_samples
from Training.NonContrastiveLearning import (
    LibrispeechDataset,
...
from Training.NonContrastiveLearning.models import BarlowTwins
from util import (
    save_model,
    save_objects,
)
...
def main(
    ...
    cache_dir = "working_dir/BarlowTwins_dataloader_cache"
    ...
    if speech_property == "Noise":
        ...
        model_path = "working_dir/models/noise_barlowtwins/"
        lambd = 1e-9
        learn_rate = 0.0001
        decay = 1e-2
        # output_size=512
    ...
    if speech_property == "Age":
        model_path = "working_dir/models/age_barlowtwins/"
        lambd = 1e-9
        learn_rate = 0.0001
        decay = 1e-5
        # output_size=512
    ...
    if speech_property == "Emotion":
        model_path = "working_dir/models/emotion_barlowtwins/"
        lambd = 0.00051
        learn_rate = 0.0001
        decay = 1e-3
        # output_size=512
    ...
    if speech_property == "IEMOCAP":
        model_path = "working_dir/models/iemocap_barlowtwins/"
        lambd = 0.00051
        learn_rate = 0.0001
        decay = 1e-3
        # output_size=512
    ...
    if speech_property == "Gender":
        model_path = "working_dir/models/gender_barlowtwins/"
        lambd = 1e-5
        learn_rate = 0.0001
        decay = 1e-2
        # output_size=512
    ...
    if speech_property == "speaker_librispeech":
        model_path = "working_dir/models/SID_barlowtwins/"
        lambd = 1e-5
        learn_rate = 0.0001
        decay = 1e-2
        # output_size=512
